        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('sendSMS', $id) }}" method="post">
                    @csrf
                    <div class="mb-3">
                        <label style="font-weight:700" for="exampleFormControlInput1" class="form-label">Số Điện Thoại Phụ Huynh</label>
                        <input value="{{ $student->student_parent_phone }}" type="text" class="form-control" id="exampleFormControlInput1" name="number"
                            placeholder="Enter Receiver Phone Number">
                    </div>
                    <div class="mb-3">
                        <label style="font-weight:700" for="exampleFormControlTextarea1" class="form-label">Tin Nhắn</label>
                    ...
                    <a href="{{ route('receipts.studentFilter',$student->class_id) }}" class="btn btn-secondary" style="margin-left: 10px;">Quay lại Danh sách sinh viên</a>
                </form>
            </div>
        </div>
    </div>
